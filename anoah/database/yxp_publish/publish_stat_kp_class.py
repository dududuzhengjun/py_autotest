...
@filename：publish_stat_kp_class
@Author: duzhengjun
@create_time：2020/6/19 15:44
...
def gen_data(count):
    ...
    for i in range(count):
        ...
        # `student_number` int(11) NOT NULL DEFAULT '0' COMMENT '参与知识点作答的学生人数',
        student_number = int(f.random.randint(0, 100))
...
try:
    # 批量执行SQL语句
    sql = """INSERT INTO yxp_publish.publish_stat_kp_class (  
                id,
                publish_id,
                knowledge_point_id, 
                knowledge_point_name,
